...
// Core logging macros
#define NE_CORE_ERROR(...) ::NIP_Engine::Log::GetCoreLogger()->error(__VA_ARGS__)
...
#define NE_CORE_TRACE(...) ::NIP_Engine::Log::GetCoreLogger()->trace(__VA_ARGS__)
#define NE_CORE_NE_CRITICAL(...) ::NIP_Engine::Log::GetCoreLogger()->critical(__VA_ARGS__)
...
#define NE_CRITICAL(...) ::NIP_Engine::Log::GetClientLogger()->critical(__VA_ARGS__)
